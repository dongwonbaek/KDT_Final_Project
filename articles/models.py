...
class Review(models.Model):
    ...
    product = models.ForeignKey('Product', on_delete=models.CASCADE)
    good_user = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='good_review')
    cool_user = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='cool_review')
    fun_user = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='fun_review')
    sad_user = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='sad_review')
